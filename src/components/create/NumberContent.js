...
export function NumberContent({setOnSubmit, shouldFormReset}) {
    ...
    return (
        <div>
            <h4 className="text-lg font-medium">{t('common.numberContent')}</h4>
            <div className="mt-4">
                <label className="block text-sm font-medium text-gray-700">{t('common.number')}:</label>
                <input
                    type="text"
                    name="name"
                    value={formData.name}
